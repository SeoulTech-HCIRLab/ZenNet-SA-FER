...
import global_utils
from contrastive_learning.losses import SupConLoss
...
def split_weights(net):
    ...
    flops, params = get_model_complexity_info(net, (3, opt.input_image_size, opt.input_image_size),
                                              as_strings=False,
...
def get_optimizer(model, opt, split=True):
    if split:
